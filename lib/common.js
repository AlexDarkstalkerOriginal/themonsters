...
var dappAddress = "n1x4XGW9Dgv7Y82MPyBnfQt9fEdE25Cva8j";
...
// мои монстры лаб
  Vue.component('my-monster-lab', {
    ...
    template: '<div class="monster">\
                ...
                <span class="weight">{{weight}} lvl</span>\
                <button v-if="sale" class="unsell"><a v-on:click="vm.unsell(id)">Cancel sell</a></button><button v-else v-on:click="vm.sell(id)" class="sell"><a href="#sell" class="popup">Sell</a></button> \
              </div>',              
  })
// мои монстры лаб
